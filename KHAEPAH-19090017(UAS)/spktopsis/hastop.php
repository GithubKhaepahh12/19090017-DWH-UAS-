    ...
    <nav class="navbar navbar-default navbar-custom navbar-dark bg-dark" style='background-color:pink;'>
      <div class="container"> 
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SPK Metode Topsis Pemilihan Customer Terbaik</a>
        </div>
    ...
    <footer class="text-center">
      <div class="footer-below">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <em>Copyright &copy; KHAEPAH - 19090017 - Politeknik Harapan Bersama TEGAL 2022</em>
            </div>
          </div>
        </div>
      </div>
